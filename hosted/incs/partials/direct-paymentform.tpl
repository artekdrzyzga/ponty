<form class="payzone-form" id="PayzonePaymentForm" name="PayzonePaymentForm" target="_parent" method="POST" style="display: block;" action="<?= $callbackurl ?>">
    ...
    <!-- Customer Details -->
    <input type="hidden" name="Address1" value="<?= $transactionResult->getAddress1(); ?>">
    ...
    <input type="hidden" name="City" value="<?= $transactionResult->getCity(); ?>">
    <input type="hidden" name="State" value="<?= $transactionResult->getState();  ?>">
    <input type="hidden" name="PostCode" value="<?= $transactionResult->getPostCode();  ?>">
    <input type="hidden" name="CountryCode" value="<?= $transactionResult->getCountryCode(); ?>">
