...
class Debug
{
     ...
     */
    //Merchant Details
    private static $version = TPCONSTS::VERSION;
    private static $vguid= TPCONSTS::VGUID;
    private static $gatewayendpoint = TPCONSTS::GATEWAYURL;
    private static $versionendpoint = TPCONSTS::MAPIURL;
    ...
    public function __construct()
    {
        ...
        self::$CustomErrorsLocationUrl  = self::getSiteUrl() . '/payzone.log';
    }
